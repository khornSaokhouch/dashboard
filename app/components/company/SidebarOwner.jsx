...
export default function SidebarOwner() {
  ...
  const links = [
    ...
    { name: "Shops", href: "/owner/shops", icon: ShoppingBagIcon },
    { name: "Category", href: "/owner/categories", icon: CubeTransparentIcon },
    { name: "Items", href: "/owner/items", icon: Cog6ToothIcon },
  ];
