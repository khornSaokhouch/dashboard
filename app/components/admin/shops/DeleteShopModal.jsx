...
export default function DeleteShopModal({ isOpen, onClose, onConfirm, isDeleting, shopToDelete, translations }) {
  return (
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        {translations.deleteShop || "Delete Shop"}
                        </Dialog.Title>
                        <div className="mt-2">
                        <p className="text-sm text-gray-500">
                            {translations.confirmDeleteMessage || "Are you sure you want to delete"}{" "}
                            <span className="font-bold">{shopToDelete?.name}</span>?{" "}
